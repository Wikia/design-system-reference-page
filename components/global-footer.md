			...
			<div class="row">
				<div class="global-footer__fandom-sections col-xs-12 col-sm-3 col-lg-offset-1 col-lg-2">
					...
					<section>
						<ul>
							<li>
								<a href="#" class="global-footer__fandom-link is-games">
									<div>Games</div>
									<svg class="global-footer__arrow icon">
										<use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icons-arrow"></use>
									</svg>
								</a>
							</li>
							<li>
								<a href="#" class="global-footer__fandom-link is-movies">
									<div>Movies</div>
									<svg class="global-footer__arrow icon">
										<use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icons-arrow"></use>
									</svg>
							...
							<li>
								<a href="#" class="global-footer__fandom-link is-tv">
									<div>TV</div>
									<svg class="global-footer__arrow icon">
										<use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icons-arrow"></use>
									</svg>
							...
							<li>
								<a href="#" class="global-footer__fandom-link is-fan-communities">
					...
					<section class="global-footer__wikia-section">
						<h3 class="global-footer__section-header">Follow Us</h3>
						<ul>
							<li class="global-footer__social-item">
								<a href="#" class="global-footer__social-link">
							...
							<li class="global-footer__social-item">
								<a href="#" class="global-footer__link">
									<svg class="global-footer__social-icon icon" alt="Twitter">
							...
							<li class="global-footer__social-item">
								<a href="#" class="global-footer__link">
									<svg class="global-footer__social-icon icon" alt="Reddit">
							...
							<li class="global-footer__social-item">
								<a href="#" class="global-footer__link">
									<svg class="global-footer__social-icon icon" alt="Youtube">
							...
							<li class="global-footer__social-item">
								<a href="#" class="global-footer__link">
									<svg class="global-footer__social-icon icon" alt="Instagram">
					...
					<div class="row">
	                    ...
	                    <div class="col-xs-12 col-sm-6 col-md-5 col-md-offset-1">
							<section class="global-footer__wikia-section is-create-wiki">
								...
								<a href="#" class="global-footer__button">Start a wikia</a>
							</section>
						</div>
